...
const UpdateStudent= 
    ...
    lastname: z.string().min(1, { error: "Last name is required." }).optional(),

    username: z
        .string()
        .min(3, { error: "Username must be at least 3 characters." }).optional(),

    state: z
        .string()
        .min(3, { error: "State must be at least 3 characters long" })
        .max(20, { error: "State must not exceed 20 characters" }).optional(),
